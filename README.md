...
Just like [V1.0.0](https://github.com/SnapperGPS/snappergps-pcb), [V2.0.0](https://github.com/SnapperGPS/snappergps-pcb-2), and [V2.2.0](https://github.com/SnapperGPS/snappergps-pcb-2-2), it is a small, low-cost, and low-power GNSS receiver intended for non-real-time wildlife tracking.
...
* The receiver is powered by two LR44, SR44, LR41, or SR41 batteries rather than a lithium-ion polymer (LiPo) battery. These are easier to obtain, cheaper, and simpler to ship, but also a bit heavier and prevent the use of custom battery sizes.

* The board is a bit larger with 27.3 mm x 36.4 mm, although, this now includes the antenna and battery footprints.
...
* The board (including antenna and batteries) weighs at least around 9.5 g. Depending on the choice of antenna and battery, this can be heavier or lighter than V1.0.0.
...
For one component, you have got two options each to create different SnapperGPS versions based on an identical PCB:
* J4, J5: These are the battery holders. Use the Keystone Electronics 2996 or 2996TR for LR44 and SR44 button batteries (Figure 1, centre), which are easy to source. Use Hong Kong CCD 704833 or similar for LR41 and SR41 button batteries (Figure 1, right). These are a bit harder to source, but using them saves about 3.5 g in total.
